...
#define PA_PROFILE 1
    ...
    #define PA_PROFILE_FUNCTION(name) ::Pistachio::InstrumentationTimer timer##__LINE__(name);
    #define PA_PROFILE_SCOPE() PA_PROFILE_FUNCTION(__FUNCSIG__)
#else
    #define PA_PROFILE_BEGIN_SESSION(name, filepath)
    #define PA_PROFILE_END_SESSION()
    #define PA_PROFILE_FUNCTION(name)
